## Taken by Rhodes
- Bandit Fight ([[Session 2]])
	- Bloodstone (Bandit Fight)
	- Bundle of Barbed Arrows 12
## Taken by Crescentia
...
- **50 GP gemstones (×8; worth 400 GP total): 
	- **Sardonyx (bands of red and white), ×2** 
	- **Quartz (white, smoky gray, or yellow), ×2** 
	- **Citrine (pale yellow brown), ×2** 
	- **Chrysoprase (green)**** 
