...
> [!infobox]
> # House Drachenweld
> ![[Art Assets/Sigils/House Drachenweld.png]]
> ###### Details
> | | |
> |---|---|
...
WHERE type = "faction-rank" AND faction = [[House Drachenweld]]
...
FROM "path/to/your/notes"
WHERE type = "npc" AND faction = [[House Drachenweld]]
SORT known DESC
```
